...
MOCK_MODULES = ['GraphRicciCurvature.OllivierRicci', 'pycombo', 'pybind11', 'ASLPAw_package', 'ipaddress', 'ASLPAw', 'graph-tool', 'leidenalg', 'numpy', 'scipy', 'networkx', 'karateclub', 'bimlpa', 'sklearn', 'pquality', 'functools', 'nf1',
